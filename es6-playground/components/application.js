...
import { TestClass } from "../components/es5-module-one.js";
...
{	
	...
	TestModuleImports()
	{
		...
		_html_string = _html_string + "<div>TestClass.TestStaticVeryLongString(): " + TestClass.TestStaticVeryLongString() + "</div>"; 
